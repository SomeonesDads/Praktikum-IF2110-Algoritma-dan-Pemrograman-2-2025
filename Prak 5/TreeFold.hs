...
treeFoldPost f b t
    | isTreeEmpty t = b
    | isBiner t = f (treeFoldPost f b (left t)) (treeFoldPost f b (right t)) (akar t)
    | isUnerLeft t = (f (treeFoldPost f b (left t)) b (akar t))
    | isUnerRight t = (f b (treeFoldPost f b (right t)) (akar t))
    | isOneElmt t = (f b b (akar t))
...
treeFoldPre f b t
    | isTreeEmpty t = b
    | isBiner t = f (akar t) (treeFoldPre f b (left t)) (treeFoldPre f b (right t)) 
    | isUnerLeft t = (f (akar t) (treeFoldPre f b (left t)) b )
    | isUnerRight t = (f (akar t) b (treeFoldPre f b (right t)) )
    | isOneElmt t = (f (akar t) b b )
...
treeFoldIn f b t
    | isTreeEmpty t = b
    | isBiner t = f  (treeFoldIn f b (left t)) (akar t) (treeFoldIn f b (right t)) 
    | isUnerLeft t = (f (treeFoldIn f b (left t)) (akar t) b )
    | isUnerRight t = (f b (akar t) (treeFoldIn f b (right t)) )
    | isOneElmt t = (f b (akar t) b )
